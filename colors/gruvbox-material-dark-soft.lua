...
local base00                          = { common.color "#252423" }
local base01                          = { common.color "#32302f" }
local base02                          = { common.color "#5a524c" }
local base03                          = { common.color "#7c6f64" }
local base04                          = { common.color "#bdae93" }
local base05                          = { common.color "#EDD6AD" }
local base06                          = { common.color "#BAAD8D" }
