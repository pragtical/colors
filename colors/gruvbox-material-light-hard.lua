...
local base00                          = { common.color "#f9f5d7" }
local base01                          = { common.color "#fbf1c7" }
local base02                          = { common.color "#e0cfa9" }
local base03                          = { common.color "#a89984" }
local base04                          = { common.color "#c9b99a" }
local base05                          = { common.color "#654735" }
local base06                          = { common.color "#968C88" }
