...
style.background3 = { common.color "#F2F0E5" }
style.text = { common.color "#857e7a" }
style.caret = { common.color "#1C1B1A" }
style.accent = { common.color "#3b76ab" }  -- blue
style.dim = { common.color "#353331" }
style.divider = { common.color "#CECDC3" }  -- ui-3
style.selection = { common.color "#DAD8CE" }  -- ui-2
style.line_number = { common.color "#a8a7a3" }  -- tx-2
style.line_number2 = { common.color "#4f4e4a" }  -- paper
...
style.syntax["keyword2"] = { common.color "#3b76ab" }  -- blue
